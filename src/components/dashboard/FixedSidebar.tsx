...
export function FixedSidebar() {
  ...
  return (
    <div className="flex h-full w-64 min-w-64 flex-col bg-background border-r">
      {/* Logo Section */}
                          ...
                          <DropdownMenuTrigger asChild>
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0 overflow-hidden">
                                <div className="truncate font-medium text-xs whitespace-nowrap text-left">
                                  {activeEvent.event_name}
                                </div>
                                <div className="truncate text-[10px] text-muted-foreground whitespace-nowrap text-left">
